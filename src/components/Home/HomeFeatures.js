                  ...
                  <div className="slider-container">
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          SN's Content Genie revolutionizes the way you create content.
                    ...
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          stories, SN's Content Genie tailors content to your specific
                    ...
                    <div className="slide flex items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Integrating seamlessly with various platforms, SN's Content Genie
                           becomes a natural extension of your workflow,
